...
export const CompanyLogo: React.FC<IconSvgProps> = ({
	...
	<Image
		src={companyImage}
		alt=""
		width={parseInt(String(size || width))}
		height={parseInt(String(size || height))}
...
export const SelectorIcon: React.FC<IconSvgProps> = ({
	size = 24,
	width,
	height,
	...props
...
export const GenderIcon: React.FC<IconSvgProps> = ({
	...
	return (
		<svg
			...
			{...props}
		>
			<path d="M11 23c-3.86 0-7-3.14-7-7s3.14-7 7-7 7 3.14 7 7-3.14 7-7 7zm0-12c-2.757 0-5 2.243-5 5s2.243 5 5 5 5-2.243 5-5-2.243-5-5-5z" fill="currentColor" />
			<path d="M11 32a1 1 0 0 1-1-1v-9a1 1 0 1 1 2 0v9a1 1 0 0 1-1 1z" fill="currentColor" />
			<path d="M14 28H8a1 1 0 1 1 0-2h6a1 1 0 1 1 0 2zM16.393 18.604a6.978 6.978 0 0 1-4.95-2.047 6.954 6.954 0 0 1-2.05-4.95c0-1.87.729-3.628 2.05-4.95a6.953 6.953 0 0 1 4.95-2.05c1.87 0 3.628.728 4.95 2.05 2.73 2.729 2.73 7.17 0 9.9a6.98 6.98 0 0 1-4.95 2.047zm0-11.998c-1.335 0-2.59.521-3.535 1.465a4.967 4.967 0 0 0-1.464 3.535c0 1.336.52 2.592 1.464 3.537a5.006 5.006 0 0 0 7.071 0 5.006 5.006 0 0 0 0-7.072 4.968 4.968 0 0 0-3.535-1.465zm-4.242.758h.01-.01zM27 7.365a1 1 0 0 1-1-1V2h-4.365a1 1 0 1 1 0-2H27a1 1 0 0 1 1 1v5.365a1 1 0 0 1-1 1z" fill="currentColor" />
			<path d="M20.636 8.364a1 1 0 0 1-.707-1.707L26.293.293a1 1 0 1 1 1.414 1.414l-6.364 6.364a.997.997 0 0 1-.707.293z" fill="currentColor" />
		</svg>
	);
};
...
export const ScheduleIcon: React.FC<IconSvgProps> = ({
	...
	return (
		...
		>
			<path
				d="M22 2h-4V0h-2v2H6V0H4v2H0v22h22zm-7 14h-3v3h-2v-3H7v-2h3v-3h2v3h3"
				fill="currentColor"
				style={{ opacity: "0.5" }}
			/>
		</svg>
...
export const HidePassIcon: React.FC<IconSvgProps> = ({
	size = 24,
	width,
	height,
	...props
...
export const ShowPassIcon: React.FC<IconSvgProps> = ({
	size = 24,
	width,
	height,
	...props
	...
	return (
		...
		>
			<path
				d="M12 5c-4.027 0-7.484 2.881-9 7 1.516 4.119 4.973 7 9 7s7.484-2.881 9-7c-1.516-4.119-4.973-7-9-7zm0 10a3 3 0 1 1 3-3 3 3 0 0 1-3 3z"
				fill="currentColor"
				style={{ opacity: "0.5" }}
			/>
		</svg>
